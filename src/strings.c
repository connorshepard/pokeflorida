...
const u8 gText_MainMenuNewGame[] = _("Move to Florida");
...
const u8 gText_BatteryRunDry[] = _("If you see this message,\nthe emulation is working.\p");
...
const u8 gText_BirchBoy[] = _("Trunks");
const u8 gText_BirchGirl[] = _("Bikini");
...
const u8 gText_ThisIsAPokemon[] = _("Hey, check this out: {PAUSE 96}\p");
...
const u8 gText_DexHoennTitle[] = _("Florida Dex");
...
const u8 gText_DexHoennDescription[] = _("Florida region's Pokédex");
...
const u8 gText_BirchInTrouble[] = _("Professor Mangrove is in trouble!\nPick a Pokémon and save him!");
...
const u8 gText_ChoosePokemon[] = _("Who should battle {STR_VAR_2}?");
...
const u8 gText_DoWhatWithPokemon[] = _("{STR_VAR_1} looks at you.");
...
const u8 gText_MenuOptionPokenav[] = _("SunPass");
...
const u8 gText_PokenavAndBag[] = _("SunPass and Bag");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Florida region.");
...
const u8 gText_PutAwayPokenav[] = _("Close the SunPass app.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Return to the SunPass menu.");
...
const u8 gText_MenuPC[] = _("{PKMN} Boxes");
...
const u8 gText_DexHoenn[] = _("Florida");
...
const u8 gText_Hoenn[] = _("Florida");
...
const u8 gText_ByeByeVar1[] = _("Adios, {STR_VAR_2}!");
const u8 gText_XSentOverY[] = _("{STR_VAR_1} sent over {STR_VAR_3}.\nHowdy, {STR_VAR_3}!");
const u8 gText_TakeGoodCareOfX[] = _("{STR_VAR_3} is happy to meet you!");
