...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Poochyena = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_DACHSBUN,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_DACHSBUN,
    .size = 512,
    .width = 32,
    .height = 32,
    .paletteSlot = PALSLOT_NPC_SPECIAL,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Dachsbun = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_DACHSBUN,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
