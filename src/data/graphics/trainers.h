...
const u32 gTrainerFrontPic_Brendan[] = INCBIN_U32("graphics/trainers/front_pics/boymc.4bpp.lz");
const u32 gTrainerPalette_Brendan[] = INCBIN_U32("graphics/trainers/front_pics/boymc.gbapal.lz");

const u32 gTrainerFrontPic_May[] = INCBIN_U32("graphics/trainers/front_pics/girlmc.4bpp.lz");
const u32 gTrainerPalette_May[] = INCBIN_U32("graphics/trainers/front_pics/girlmc.gbapal.lz");
